...
\begin{align*}
    ...
    \infrule{\phi_i \ra \bot}{\phi_1 \wedge \phi_2 \ra \bot} &where\ i\in \{1,2\}\tag{And False}\\
    \infrule{\phi_i \ra \top}{\phi_1 \vee \phi_2 \ra \top} &where\ i\in \{1,2\} \tag{Or True}\\
...
%The rules for arithmetic logic are shown below. The arithmetic logic rules are not determined of the terms are comparable, like numbers and strings are but, if it happens they are incomparable.

%The rules for arithmetic logic are not determined if the terms are comparable, like numbers are but, if it happens they are incomparable.
