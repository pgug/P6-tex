...
\noindent
In \figref{fig:reductionexample} we have by reduction proved that $!P$ can run $P$ in parallel infinity many times, by applying the rule again. The Replication is a coding developed by  L. G. Meredith and M. Radestock in \citep{Meredith2005}
\FloatBarrier