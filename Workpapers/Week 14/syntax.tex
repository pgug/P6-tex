...
P::=& \ [\phi] P
\end{align*}
In addition to terms and process we need to use boolean arithmetic, which will be determined by \ensuremath{\phi}, and an additional rule is applied to \textit{P}.